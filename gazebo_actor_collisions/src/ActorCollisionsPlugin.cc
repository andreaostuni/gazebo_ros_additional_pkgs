...
#include "gazebo_actor_collisions/ActorCollisionsPlugin.hh"
#include <iostream>
...
void ActorCollisionsPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  std::unordered_map<std::string, ignition::math::Vector3d> scaling;
  std::unordered_map<std::string, ignition::math::Pose3d> offsets;
